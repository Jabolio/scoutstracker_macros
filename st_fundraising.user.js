...
// @updateURL    https://github.com/Jabolio/scoutstracker_macros/raw/main/st_fundraising.user.js
// @downloadURL  https://github.com/Jabolio/scoutstracker_macros/raw/main/st_fundraising.user.js
...
(function() {
    ...
    const NODES = [VIEW_EVENT, RESOLUTION];
    ...
    fcm_observer.observe(document.querySelector(VIEW_EVENT), {
        attributes: true
    });
    ...
    $(RESOLUTION).before('<ul id="event-fundraising-credit" class="rounded edit"><li><a href="javascript:void(0)"><div>Per-Youth Profit for This Event</div><input type="number" min="1" step="0.01" /><div class="button" id="shareProfitBtn">Share</div></a></li></ul>');
})();